        ...
        <header>
            <nav class="navbar">
                ...
                <div class="right">
                    ...
                    <div class="account">
                        <img class="icon" src="/assets/developers/Gabija.jpg"
                            alt="Account Icon">
                    </div>
                </div>
            </nav>
        ...
        <main id="recipeDetailContainer">
            <section class="recipe-hero">
                <div class="hero-image-container">
                    <img src="/assets/food/Monte-Cristo-Sandwich-1664x834-1.jpg" alt="Monte Cristo Sandwich"
                        class="recipe-image" id="recipeImage">
                    <div class="hero-overlay">
                        <h1 class="recipe-title" id="recipeTitle">Monte Cristo Sandwich</h1>
                        <div class="share-icons">
                            <img src="/assets/icons/heart_plus_24dp_000000_FILL0_wght400_GRAD0_opsz24.png" alt="Save Icon"
                                class="icon save-icon">
                            <img src="/assets/icons/share_24dp_000000_FILL0_wght400_GRAD0_opsz24.png" alt="Share Icon"
            ...
            <section class="recipe-meta-container">
                <div class="author-info">
                    <img src="/assets/food/Monte-Cristo-Sandwich-1664x834-1.jpg" alt="Author Avatar" class="author-avatar">
                ...
                <div class="meta-details">
                    <div class="meta-item">
                        <img src="/assets/icons/blender_24dp_000000_FILL0_wght400_GRAD0_opsz24.png"
                            alt="Preparation Time Icon" class="icon">
                        <p><strong>Preparation time</strong> 30 minutes</p>
                    </div>
                    <div class="meta-item">
                        <img src="/assets/icons/skillet_24dp_000000_FILL0_wght400_GRAD0_opsz24.png"
                            alt="Cooking Time Icon" class="icon">
                        <p><strong>Cooking time</strong> 30 min to 1 hour</p>
                    </div>
                    <div class="meta-item">
                        <img src="/assets/icons/hand_meal_24dp_000000_FILL0_wght400_GRAD0_opsz24.png" alt="Servings Icon"
                            class="icon">
            ...
            <section class="comments-section">
                ...
                <div class="comment-form">
                    <img src="/assets/developers/Gabija.jpg" alt="User Avatar" class="user-avatar">
                        ...
                        <div class="comment-details">
                            ...
                            <div class="comment-actions">
                                <span class="likes"><img
                                        src="/assets/icons/thumb_up_24dp_000000_FILL0_wght400_GRAD0_opsz24.png"
                                        alt="Like Button" class="icon"></span>
                                <span class="reply"><img
                                        src="/assets/icons/thumb_down_24dp_000000_FILL0_wght400_GRAD0_opsz24.png"
                                        alt="Dislike Button" class="icon"></span>
                            </div>
                        </div>
                    </div>
                </div>
